...
2.  Reverse-coding, recoding categorical variable, and creating total
    scores.
...
```
    ...
    ## Warning: Problem with `mutate()` input `comp7r`.
    ## i Unreplaced values treated as NA as .x is not compatible. Please specify replacements exhaustively or supply .default
    ## i Input `comp7r` is `recode(...)`.

    ## Warning: Unreplaced values treated as NA as .x is not compatible. Please specify
    ## replacements exhaustively or supply .default

    ## Warning: Problem with `mutate()` input `comp8r`.
    ## i Unreplaced values treated as NA as .x is not compatible. Please specify replacements exhaustively or supply .default
    ## i Input `comp8r` is `recode(...)`.

    ## Warning: Unreplaced values treated as NA as .x is not compatible. Please specify
    ## replacements exhaustively or supply .default

    ## Warning: Problem with `mutate()` input `comp9r`.
    ## i Unreplaced values treated as NA as .x is not compatible. Please specify replacements exhaustively or supply .default
    ## i Input `comp9r` is `recode(...)`.

    ## Warning: Unreplaced values treated as NA as .x is not compatible. Please specify
    ## replacements exhaustively or supply .default

    ## Warning: Problem with `mutate()` input `comp10r`.
    ## i Unreplaced values treated as NA as .x is not compatible. Please specify replacements exhaustively or supply .default
    ## i Input `comp10r` is `recode(...)`.

    ## Warning: Unreplaced values treated as NA as .x is not compatible. Please specify
    ## replacements exhaustively or supply .default

    ## Warning: Problem with `mutate()` input `intel7r`.
    ## i Unreplaced values treated as NA as .x is not compatible. Please specify replacements exhaustively or supply .default
    ## i Input `intel7r` is `recode(...)`.

    ## Warning: Unreplaced values treated as NA as .x is not compatible. Please specify
    ## replacements exhaustively or supply .default

    ## Warning: Problem with `mutate()` input `intel8r`.
    ## i Unreplaced values treated as NA as .x is not compatible. Please specify replacements exhaustively or supply .default
    ## i Input `intel8r` is `recode(...)`.

    ## Warning: Unreplaced values treated as NA as .x is not compatible. Please specify
    ## replacements exhaustively or supply .default

    ## Warning: Problem with `mutate()` input `intel9r`.
    ## i Unreplaced values treated as NA as .x is not compatible. Please specify replacements exhaustively or supply .default
    ## i Input `intel9r` is `recode(...)`.

    ## Warning: Unreplaced values treated as NA as .x is not compatible. Please specify
    ## replacements exhaustively or supply .default

    ## Warning: Problem with `mutate()` input `intel10r`.
    ## i Unreplaced values treated as NA as .x is not compatible. Please specify replacements exhaustively or supply .default
    ## i Input `intel10r` is `recode(...)`.

    ## Warning: Unreplaced values treated as NA as .x is not compatible. Please specify
    ## replacements exhaustively or supply .default

    ## Warning: Problem with `mutate()` input `open7r`.
    ## i Unreplaced values treated as NA as .x is not compatible. Please specify replacements exhaustively or supply .default
    ## i Input `open7r` is `recode(...)`.

    ## Warning: Unreplaced values treated as NA as .x is not compatible. Please specify
    ## replacements exhaustively or supply .default

    ## Warning: Problem with `mutate()` input `open10r`.
    ## i Unreplaced values treated as NA as .x is not compatible. Please specify replacements exhaustively or supply .default
    ## i Input `open10r` is `recode(...)`.

    ## Warning: Unreplaced values treated as NA as .x is not compatible. Please specify
    ## replacements exhaustively or supply .default

    ## Warning: Problem with `mutate()` input `student`.
    ## i Unreplaced values treated as NA as .x is not compatible. Please specify replacements exhaustively or supply .default
    ## i Input `student` is `recode(student, `1` = "not a student", `2` = "student", .missing = "(Unknown)")`.
...
Since the scores go from 1-5, I’m going to multiply values by 20, so
that the maximum number is 100. Name the rescaled variables `*_pomp`.
...
5.  Make scatterplots showing the relationships between **green
    reputation** and each personality trait.
...
ggplot() +
  aes(GreenRep_pomp, Compassion_pomp) +
  geom_point()
```

    ## Warning: Removed 86 rows containing missing values (geom_point).

![](hw03_files/figure-gfm/unnamed-chunk-8-1.png)<!-- --> Include trend
lines for **students** and **non-students**.
...
```
    ...
    ## 2 not a ~       3.54       0.886            4            1            5
    ## 3 student       3.46       0.833            4            1            5
    ## 4 <NA>          4         NA                4            4            4
